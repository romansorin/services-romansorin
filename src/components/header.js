    ...
    <nav className='font-body container flex items-center mx-auto justify-between flex-wrap bg-transparent py-6'>
      ...
      <div className='w-full block lg:flex lg:items-center lg:w-auto'>
        <div className='text-base lg:flex-grow'>
          <a
            href='https://www.romansorin.com'
            className='block mt-4 font-medium tracking-wide lg:inline-block lg:mt-0 text-white hover:text-white mr-12'
          >
            Contact
          </a>
          <ButtonLink
            link='https://www.romansorin.com'
            styles='text-base rounded px-3 py-2 leading-none tracking-wide border font-semibold text-darkgrey bg-white border-white hover:border-transparent hover:text-gray-500 hover:bg-white shadow-lg mt-4 lg:mt-0'
          >
